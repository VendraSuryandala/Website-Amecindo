...
const Navbar = () => {
    ...
    return(
      <div className='absolute flex w-full justify-between mx-auto h-20 max-w-[1240px] items-center bg-dark px-4 z-10 text-white shadow-md shadow-black'>
      <img src={bglogo} width={60} height={20} alt='/' data-aos="fade" />
